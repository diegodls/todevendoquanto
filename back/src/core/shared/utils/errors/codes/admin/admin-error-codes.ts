import {
  AdminControllerErrorCodesInterface,
  AdminServiceErrorCodesInterface,
} from "@/core/shared/utils/errors/codes/admin/admin-error-codes-interface";

export const adminControllerErrorCodes: AdminControllerErrorCodesInterface = {
  E_0_CTR_ADM_0001: {
...
export const adminServiceErrorCodes: AdminServiceErrorCodesInterface = {
  E_0_SVC_ADM_0001: {
