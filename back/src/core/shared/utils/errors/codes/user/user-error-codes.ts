import {
  UserControllerErrorCodesInterface,
  UserServiceErrorCodesInterface,
} from "@/core/shared/utils/errors/codes/user/user-error-codes-interface";
...
export const userServiceErrorCodes: UserServiceErrorCodesInterface = {
  E_0_SVC_USR_0001: {
